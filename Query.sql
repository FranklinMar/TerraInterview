...
Add any garnish of your preference.', '1.jpg');
INSERT INTO quantities VALUES (DEFAULT, 1,
(SELECT id FROM ingredients WHERE name = 'Warm water'),
(SELECT id FROM recipes WHERE name = 'Pizza'));
INSERT INTO quantities VALUES (DEFAULT, 1,
(SELECT id FROM ingredients WHERE name = 'Sugar'),
(SELECT id FROM recipes WHERE name = 'Pizza'));
INSERT INTO quantities VALUES (DEFAULT, 2,
(SELECT id FROM ingredients WHERE name = 'Active dry yeast'),
(SELECT id FROM recipes WHERE name = 'Pizza'));
INSERT INTO quantities VALUES (DEFAULT, 875,
(SELECT id FROM ingredients WHERE name = 'Flour'),
(SELECT id FROM recipes WHERE name = 'Pizza'));
INSERT INTO quantities VALUES (DEFAULT, 6,
(SELECT id FROM ingredients WHERE name = 'Plant oil'),
(SELECT id FROM recipes WHERE name = 'Pizza'));
INSERT INTO quantities VALUES (DEFAULT, 1,
